...
const translations = {
  es: {
    ...
    "chat.disclaimer": "Para activar IA real en Vercel, agrega la variable OPENAI_API_KEY.",
  ...
  en: {
    ...
    "chat.disclaimer": "To activate real AI in Vercel, add the OPENAI_API_KEY variable.",
