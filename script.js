...
const translations = {
  es: {
    ...
    "order.homeTitle": "Inicia una orden en línea",
    "order.homeCopy": "Envía pedidos de impresión, multiservicios o agente consultor con detalles, archivos y datos de contacto.",
    "order.kicker": "Solicitud rápida en línea",
    "order.title": "Inicia tu orden en minutos.",
    "order.copy": "Elige un servicio, agrega detalles, sube un archivo si hace falta y recibe un número de orden para seguimiento.",
    ...
    "order.detailsTitle": "Detalles de la orden",
    ...
    "order.dueDate": "Fecha necesaria",
    "order.budget": "Presupuesto estimado",
    ...
    "zelle.step2": "Envía el pago por Zelle a nextprintny@gmail.com.",
  ...
  en: {
    ...
    "order.homeTitle": "Start an order online",
    "order.homeCopy": "Send printing, multiservices or consulting requests with details, files and contact information.",
    "order.kicker": "Fast online request",
    "order.title": "Start your order in minutes.",
    "order.copy": "Choose a service, add details, upload a file if needed and receive an order number for follow-up.",
    "order.whatsapp": "WhatsApp",
    ...
    "order.dueDate": "Date needed",
    "order.budget": "Estimated budget",
    ...
    "zelle.step2": "Send the Zelle payment to nextprintny@gmail.com.",
